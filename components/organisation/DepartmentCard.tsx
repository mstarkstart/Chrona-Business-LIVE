...
import { Trash2, Users, CheckSquare, Layers, X, Shield, Loader2 } from "lucide-react";
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade-in">
          ...
          <div className="relative w-full max-w-sm rounded-2xl border border-slate-200 bg-white/90 backdrop-blur-xl p-6 shadow-2xl animate-scale-in z-10 text-center">
            {/* Alert Icon */}
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-red-50 text-red-655 border border-red-100 mb-4 animate-pulse-soft">
              <Trash2 className="h-5 w-5" />
            </div>
            
            <h3 className="text-base font-bold text-foreground mb-1.5">Delete Department?</h3>
            <p className="text-xs text-muted-foreground leading-relaxed mb-5">
              Are you sure you want to delete <span className="font-semibold text-foreground">"{name}"</span>? This action is permanent and all child teams and assignments will be cleared.
            </p>
