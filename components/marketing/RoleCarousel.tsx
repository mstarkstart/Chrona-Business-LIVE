...
const ROLES = [
  {
    ...
    label: "Owner",
    color: "#4f46e5",
    sees: ["Workspace-wide progress", "Every project & team", "Billing, members & approvals"],
  ...
  },
  {
    ...
    label: "Admin",
    color: "#6366f1",
    sees: ["Cross-project progress", "Member management", "Workspace settings"],
    description: "Runs the workspace day-to-day, minus billing & deletion.",
  },
  {
    key: "manager",
    icon: Users,
    label: "Manager",
    color: "#8b5cf6",
    sees: ["Project-level stats", "Task approvals", "Automations & invites"],
    description: "Owns projects and tasks. Assigns work and approves it.",
  },
  {
    key: "member",
    icon: Star,
    label: "Member",
    color: "#a855f7",
    sees: ["Personal tasks", "Today's schedule", "Comments & docs"],
    description: "Creates and works tasks. The core of every team.",
  },
  {
    key: "guest",
    icon: User,
    label: "Guest",
    color: "#c084fc",
    sees: ["Shared projects", "Read-only boards", "Comment threads"],
    description: "External collaborators. View and comment, nothing more.",
  },
];
