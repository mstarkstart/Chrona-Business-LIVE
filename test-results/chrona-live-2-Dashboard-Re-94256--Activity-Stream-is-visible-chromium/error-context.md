...
- Name: chrona-live.spec.ts >> 2. Dashboard & Real-time Widgets >> 2c. Live Activity Stream is visible
- Location: tests\chrona-live.spec.ts:85:7
...
Locator: locator('text=Live Activity Stream')
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('text=Live Activity Stream')
...
> 86  |     await expect(page.locator("text=Live Activity Stream")).toBeVisible();
  ...
  183 | 
  184 | // ─── SUITE 4: Tasks ────────────────────────────────────────────────────────────
  185 | test.describe("4. Task Management (My Work)", () => {
