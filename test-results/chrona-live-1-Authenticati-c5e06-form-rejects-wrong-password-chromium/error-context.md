...
- Name: chrona-live.spec.ts >> 1. Authentication Flow >> 1d. Login form rejects wrong password
- Location: tests\chrona-live.spec.ts:58:7
...
Received string: "http://localhost:3000/login?error=Invalid%20login%20credentials&next=%2Fdashboard"
Timeout: 8000ms

Call log:
  - Expect "not toHaveURL" with timeout 8000ms
    19 × unexpected value "http://localhost:3000/login?error=Invalid%20login%20credentials&next=%2Fdashboard"
...
- main:
  ...
  - paragraph: Sign in to your Chrona workspace
  - button "Google Soon" [disabled]:
    - img
    - text: Google Soon
  - button "Microsoft Soon" [disabled]:
    - img
    - text: Microsoft Soon
