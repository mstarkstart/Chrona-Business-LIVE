...
- Name: chrona-live.spec.ts >> 2. Dashboard & Real-time Widgets >> 2a. Dashboard renders greeting, date, and role badge
- Location: tests\chrona-live.spec.ts:73:7
...
Received string:  "Tell us about your business"
Timeout: 8000ms

Call log:
  - Expect "toContainText" with timeout 8000ms
  - waiting for locator('h1')
    12 × locator resolved to <h1 class="text-3xl font-bold tracking-tight text-foreground">Tell us about your business</h1>
       - unexpected value "Tell us about your business"
